...
public class Pref {
    ...
    private static final String KEY_OPEM_RESTART = "KEY_OPEM_RESTART";
    ...
    public static boolean isOpenRestartTask(){
        return def().getBoolean(KEY_OPEM_RESTART, false);
    }

    public static void setOpenRestartTask(boolean checked){
        def().edit().putBoolean(KEY_OPEM_RESTART, checked).apply();
    }
